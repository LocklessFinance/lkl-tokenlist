...
interface YVaultV4AssetProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class YVaultV4AssetProxy extends Contract {
  ...
  interface: YVaultV4AssetProxyInterface;
