...
interface ERC20PermitWithMiningInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20PermitWithMining extends Contract {
  ...
  interface: ERC20PermitWithMiningInterface;
